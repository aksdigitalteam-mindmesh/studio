 ...
 * Muscle groups match the 10 categories tracked on the fatigue page:
 * chest, biceps, abs, quads, shoulders, back, triceps, glutes, hamstrings, calves
 */
...
export const WORKOUT_DATABASE: InbuiltExercise[] = [
  ...
  { name: 'Incline Dumbbell Press', muscleGroups: ['chest', 'shoulders'], equipment: 'with', difficulty: 'medium', description: 'Dumbbell press on an inclined bench.', baseSets: 3, baseReps: '10-12' },
  ...
  { name: 'Bent Over Rows', muscleGroups: ['back', 'shoulders'], equipment: 'with', difficulty: 'medium', description: 'Barbell or dumbbell rows.', baseSets: 4, baseReps: '10-12' },
  { name: 'Superman', muscleGroups: ['back'], equipment: 'without', difficulty: 'low', description: 'Lying face down, lift arms and legs.', baseSets: 3, baseReps: '15' },
  ...
  { name: 'Pike Push-ups', muscleGroups: ['shoulders', 'triceps'], equipment: 'without', difficulty: 'medium', description: 'Hips high push-ups targeting delts.', baseSets: 3, baseReps: '10-12' },
  ...
  { name: 'Barbell Squats', muscleGroups: ['quads', 'glutes'], equipment: 'with', difficulty: 'high', description: 'Back squats with barbell.', baseSets: 4, baseReps: '8-10' },
  ...
  { name: 'Romanian Deadlifts', muscleGroups: ['hamstrings', 'glutes', 'back'], equipment: 'with', difficulty: 'medium', description: 'Stiff-leg deadlifts.', baseSets: 3, baseReps: '10-12' },
  ...
  // CORE
  { name: 'Plank', muscleGroups: ['abs'], equipment: 'without', difficulty: 'low', description: 'Forearm plank hold.', baseSets: 3, baseReps: '45-60s' },
  { name: 'Leg Raises', muscleGroups: ['abs'], equipment: 'without', difficulty: 'medium', description: 'Lying leg lifts.', baseSets: 3, baseReps: '15' },
  { name: 'Russian Twists', muscleGroups: ['abs'], equipment: 'without', difficulty: 'low', description: 'Seated torso rotations.', baseSets: 3, baseReps: '20 per side' },
  
  // CALVES
  { name: 'Calf Raises', muscleGroups: ['calves'], equipment: 'without', difficulty: 'low', description: 'Standing calf raises on flat ground or step.', baseSets: 3, baseReps: '20-25' },
];
